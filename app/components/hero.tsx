...
const fadeInDown = { hidden: { opacity: 0, y: -50 }, visible: { opacity: 1, y: 0 } };
      ...
      <div className="pt-12 ml-4 md:p-24">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          >
            ...
            <a
              href="https://low-centaur-4a2.notion.site/24879d01f30580389689e2a00edc6b4f?v=24879d01f30581f797b3000c6c8ab662&source=copy_link"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl ml-6 p-2 rounded-full border-mocha-400 border-2 hover:text-vanilla-100 hover:bg-mocha-400 hover:scale-110 duration-300"
            >
              <CiCoffeeCup />
            </a>
          </motion.div>
